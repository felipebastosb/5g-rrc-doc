...
![Aquisição de informações do sistema](/assets/imgs/paging.png)
...
- Se o drb-Identity não estiver incluído na drb-CountMSB-InfoList:
    - Incluir o DRB na drb-CountInfoList na mensagem CounterCheckResponse definindo drb-Identity, count-Uplink e count-Downlink com o valor de TX_NEXT - 1 e RX_NEXT - 1 (especificado no TS 38.323).
