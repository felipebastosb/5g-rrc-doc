...
--------------------- | --------------------- 
Broadcast de informações comuns                 | lorem ipsum           
Notificações da rede para UE (chamadas, etc.) | lorem ipsum dolor sit 
Transferência de sinalizações | lorem ipsum dolor sit 
Broadcast de posições | lorem ipsum dolor sit
Transferência de medidas, configurações, e logs | lorem ipsum dolor sit
...
O pagin é um tipo de mensagem que a estação rádio base usa para informar os usuários que está disponível para iniciar o processo de conexão RRC.
